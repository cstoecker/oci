...
export default {
DSCSADispenserATPCredential: require('./schemas/DSCSADispenserATPCredential.json'),
DSCSAManufacturerATPCredential: require('./schemas/DSCSAManufacturerATPCredential.json'),
