...
- Code Generation to create synthetic test data is located in [generators](packages/oci-schemas/src/generators)
- Test Vectors are run against fixtures that are auto generated and located in the [fixtures](packages/oci-schemas/src/__fixtures__) folder, and correspond to the defined schemas
...
All the terms, schemas and context definitions are generated from [./packages/traceability-schemas](packages/oci-schemas).
...
1. create a [JSON Schema](https://json-schema.org/) in the [schemas](packages/oci-schemas/schemas) folder.
2. add synthetic data generation for it to the [generators](packages/oci-schemas/src/generators).
...
- [Data Generator](packages/oci-schemas/src/generators/Place.js)
